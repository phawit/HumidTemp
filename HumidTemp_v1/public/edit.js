...
var iTemp,iHumid;
var imei, unit_curr, unit_new, line1, line2,tempX,humidX;
      ...
      if (imei == key)
      {
        ...
        db_id.once('value',function (snapshot_id) {
          ...
          if (unit_curr == data['UnitName']){
            ...
            console.log(iTemp);
            console.log(iHumid);
            console.log(parseFloat(iTemp+temp-tempX).toFixed(2));
            console.log(parseFloat(iHumid+humid-humidX).toFixed(2));
            data['iTemp'] = ((iTemp+temp-tempX)+0.00000000000001).toFixed(2);
            data['iHumid'] = ((iHumid+humid-humidX)+0.00000000001).toFixed(2);
            // data['iTemp'] = 0;
            // data['iHumid'] = 0;
