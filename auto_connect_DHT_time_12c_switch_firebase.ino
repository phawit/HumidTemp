...
void pubFirebase(){
  ...
  pub = Firebase.getInt("ID/A03/Current/Pub");
  ...
  if(pub == 0){
    ...
    iHumid = Firebase.getInt("ID/A03/Current/iHumid");
    iTemp = Firebase.getInt("ID/A03/Current/iTemp");
    Firebase.setInt("ID/A03/Current/Pub",0);
    pub = 0;
  ...
  Firebase.setFloat("ID/A03/Current/Temperature", temp);
  Firebase.setFloat("ID/A03/Current/HUmid", humid);
  Firebase.setFloat("ID/A03/Current/HID", hic);
//  Firebase.setFloat("ID/A03/Current/Pub", pub);
